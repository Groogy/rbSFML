module SFML
  ...
  # <tt>Vector3</tt> is a simple class that defines a mathematical vector with two coordinates (<tt>x</tt>, <tt>y</tt> and <tt>z</tt>).
  # 
  ...
  # 
  # The <tt>Vector3</tt> class has a small and simple interface, its <tt>x</tt>, <tt>y</tt> and <tt>z</tt> attributes can be accessed directly and it contains no mathematical function like dot product, cross product, length, etc.
  # 
  # A array whose arguments fits on <tt>Vector3.new()</tt> or a single numeric value can be used as argument anywhere a vector3 is requested.
  # 
